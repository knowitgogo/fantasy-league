            ...
            <nav class="flex-1 space-y-1 px-3 py-4">
                ...
                <a href="{{ route('tournaments.index') }}" class="group flex items-center rounded-lg px-3 py-2.5 text-sm font-medium text-slate-400 transition hover:bg-slate-800 hover:text-white">
                    <svg class="mr-3 h-5 w-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5 11a1 1 0 011-1h2V7a4 4 0 014-4h.5a1.5 1.5 0 110 3H10a1 1 0 00-1 1v3a1 1 0 001 1h.5a1.5 1.5 0 110 3H10a4 4 0 01-4-4v-2H6a1 1 0 01-1-1zm12 2a1 1 0 11-2 0 1 1 0 012 0z"></path>
                    </svg>
                ...
                <a href="{{ route('admin.users') }}" class="group flex items-center rounded-lg px-3 py-2.5 text-sm font-medium text-slate-400 transition hover:bg-slate-800 hover:text-white">
                    <svg class="mr-3 h-5 w-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="lg:ml-64">
            ...
            <main class="px-5 py-6 lg:px-8">
                <section class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                    <a href="{{ route('admin.users') }}" class="block rounded-lg border border-slate-700 bg-slate-900 p-5 shadow-sm transition hover:bg-slate-800 hover:scale-[1.02]">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <svg class="h-5 w-5 flex-shrink-0 text-slate-400"
                                ...
                                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v1h8v-1zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-1a4 4 0 00-8 0v1h8z"></path>
                    ...
                    <a href="{{ route('tournaments.index') }}"
                        class="block rounded-lg border border-slate-700 bg-slate-900 p-5 shadow-sm transition duration-200 hover:scale-[1.02] hover:bg-slate-800 hover:shadow-lg">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <svg class="h-5 w-5 flex-shrink-0 text-slate-400"
                                ...
                                <path fill-rule="evenodd"
                                    d="M4 5a2 2 0 012-2 1 1 0 000-2 4 4 0 00-4 4v10a4 4 0 004 4h12a4 4 0 004-4V5a4 4 0 00-4-4 1 1 0 000 2 2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V5z"></path>
                    ...
                    <a href="{{ route('teams.index') }}"
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <svg class="h-5 w-5 flex-shrink-0 text-slate-400"
                                ...
                                <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 11a6 6 0 00-11.86 0v2a1 1 0 001 1h9.86a1 1 0 001-1v-2z"></path>
